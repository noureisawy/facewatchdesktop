...
class ReadLabeledImage(ReadImages):
    ...
    def __init__(self, list_widget, label, date_created):
        super().__init__("labeled", list_widget)     
        self.label = label
        self.data = Data.get_instant()
        self.date_created = date_created

    def read_images(self):
        file_name = f"{directory}/{self.directory}/{self.label}_{self.date_created}.jpg"
